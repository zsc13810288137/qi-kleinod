        ...
        <div className="flex flex-col md:flex-row gap-5 md:items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              Mehr Informationen findest du in unserer <a href="/datenschutz" className="underline hover:text-black">Datenschutzerklärung</a>.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <button
              onClick={rejectAll}
              className="px-5 py-2.5 text-sm border border-gray-300 rounded-2xl hover:bg-gray-50 transition whitespace-nowrap"
            >
              Ablehnen
            </button>
            <button
