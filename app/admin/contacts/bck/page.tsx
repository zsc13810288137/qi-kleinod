...
export default function AdminContactsPage() {
  ...
  const loadAdminHash = async () => {
    console.log("正在从 Supabase 加载密码 hash...");
    ...
    if (error) {
      console.error("加载 hash 失败:", error);
      setAdminHash(null);
    } else if (data && data.value) {
      console.log("成功加载 hash:", data.value.substring(0, 20) + "...");
  ...
  const handlePasswordSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!adminHash) {
      alert("密码配置加载失败，请刷新页面或检查 Supabase");
      return;
    }
              ...
              <div className="space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                {contacts.map((contact) => (
                  <div
                    ...
                    className={`p-5 border rounded-2xl cursor-pointer hover:border-black transition flex justify-between items-start ${
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="mt-2 font-medium line-clamp-1">{contact.subject}</p>
                    </div>
                    <div className="text-right flex flex-col items-end gap-2">
                      ...
                      <button
                        ...
                        className="text-red-500 hover:text-red-700 text-xs px-3 py-1 hover:bg-red-50 rounded"
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-40 p-4 border border-gray-300 rounded-2xl focus:outline-none focus:border-black"
                    />
                  </div>
                </div>
