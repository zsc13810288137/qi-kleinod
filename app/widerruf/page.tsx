    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="prose prose-gray max-w-none bg-white p-8 rounded-3xl shadow-sm text-gray-900 leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Widerrufsrecht</h2>
          <p className="text-gray-800">
            Sie haben das Recht, binnen 14 Tagen ohne Angabe von Gründen diesen Vertrag zu widerrufen.
          </p>

          <h2 className="text-2xl font-semibold mt-12 mb-6 text-gray-900">Widerrufsfrist</h2>
          <p className="text-gray-800">
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6 text-gray-900">Um Ihr Widerrufsrecht auszuüben</h2>
          <p className="text-gray-800">
